...
public class SizeFormatter {
    public static final FormatSet BYTES_THREE_SIGNIFICANT = new FormatSet(
    ...
    public static final FormatSet DURATION = new FormatSet(
    ...
    @SuppressWarnings("unused")
    public static final FormatSet SECONDS_AS_POSITION = new FormatSet(
    ...
    @SuppressWarnings("unused")
    public static final FormatSet MILLISECONDS = new FormatSet(
            new Format("%sd %s:%s:%s",
                    -1,
                    new Format("%.0f", 24L * 60 * 60 * 1000),
                    new Format("%02.0f", 60L * 60 * 1000),
                    new Format("%02.0f", 60 * 1000),
                    new Format("%06.3f", 1000)));
    ...
    private static class Format {
        ...
        Format(String formatString, long divisor, long cutOff) {
        ...
        Format(String formatString, long divisor) {
            this(formatString, divisor, -1);
        }

        Format(String formatString, long cutOff, Format... formats) {
            this.formatString = formatString;
            this.cutOff = cutOff;
            this.divisor = 1;
            this.formats = formats;
        ...
        boolean isApplicable(long number) {
